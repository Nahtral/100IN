...
DROP VIEW IF EXISTS vw_player_dashboard_metrics CASCADE;
DROP MATERIALIZED VIEW IF EXISTS vw_player_dashboard_metrics CASCADE;
...
-- Recreate the RPC function with the correct player-team relationships
