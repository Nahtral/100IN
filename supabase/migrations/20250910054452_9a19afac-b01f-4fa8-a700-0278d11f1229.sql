...
INSERT INTO public.player_teams (player_id, team_id, is_active, joined_at, created_at, updated_at)
SELECT 
  p.id as player_id,
  t.id as team_id,
  true as is_active,
...
-- Step 4: Update player counts in teams table for consistency (optional)
-- This could be done via a trigger, but for now we'll just ensure data is clean