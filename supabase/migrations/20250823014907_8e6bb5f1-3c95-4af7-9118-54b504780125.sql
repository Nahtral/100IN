...
CREATE OR REPLACE FUNCTION public.get_benefit_cost_analysis(report_start_date DATE DEFAULT DATE_TRUNC('month', CURRENT_DATE), report_end_date DATE DEFAULT CURRENT_DATE)
RETURNS TABLE (
  plan_type TEXT,
