-- Create membership tracking system (fixed)
...
CREATE INDEX IF NOT EXISTS idx_player_memberships_player_status ON public.player_memberships(player_id, status);
CREATE INDEX IF NOT EXISTS idx_membership_alerts_sent_membership_alert ON public.membership_alerts_sent(player_membership_id, alert_code);
