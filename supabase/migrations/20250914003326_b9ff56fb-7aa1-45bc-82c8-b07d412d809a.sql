...
-- Create the index AFTER the table is created
CREATE INDEX IF NOT EXISTS idx_pm_player_active ON public.player_memberships(player_id) WHERE is_active = true;
