-- Insert sample teams (without division column since it doesn't exist)
INSERT INTO teams (name, age_group, season) 
SELECT 'Eagles', 'U18', '2024-25'
WHERE NOT EXISTS (SELECT 1 FROM teams WHERE name = 'Eagles');

INSERT INTO teams (name, age_group, season) 
SELECT 'Hawks', 'U16', '2024-25'
WHERE NOT EXISTS (SELECT 1 FROM teams WHERE name = 'Hawks');

INSERT INTO teams (name, age_group, season) 
SELECT 'Lions', 'U14', '2024-25'
WHERE NOT EXISTS (SELECT 1 FROM teams WHERE name = 'Lions');

INSERT INTO teams (name, age_group, season) 
SELECT 'Bears', 'U12', '2024-25'
...
DROP POLICY IF EXISTS "Partners can view their own sponsorships" ON partner_team_sponsorships;
...
DROP POLICY IF EXISTS "Super admins can manage all sponsorships" ON partner_team_sponsorships;
