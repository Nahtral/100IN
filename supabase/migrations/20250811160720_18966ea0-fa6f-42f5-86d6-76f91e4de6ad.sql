...
-- Add unique constraint on name for teams table if it doesn't exist
ALTER TABLE teams ADD CONSTRAINT teams_name_unique UNIQUE (name);

-- Insert sample partner organizations (check if they don't already exist)
