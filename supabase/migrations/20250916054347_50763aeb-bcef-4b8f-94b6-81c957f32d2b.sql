-- Phase 1: Create missing view and fix schema issues
...
-- Add the view to realtime publication for real-time updates
ALTER publication supabase_realtime ADD TABLE public.v_player_attendance_summary;