-- Create membership tracking system (fixed - correct player name column)
...
-- Create indexes for performance (avoiding duplicate idx_players_active)
...
-- Create view for membership usage calculations (using correct player name column)
