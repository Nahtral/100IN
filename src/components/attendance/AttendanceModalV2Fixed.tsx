...
export const AttendanceModalV2Fixed: React.FC<AttendanceModalV2Props> = ({
  isOpen,
  onClose,
  eventId,
  teamId,
  ...
  const fetchPlayersAndAttendance = async () => {
    ...
    try {
      ...
      // Get team members with profiles using proper join syntax
      ...
      // Combine the data - handle the type properly
